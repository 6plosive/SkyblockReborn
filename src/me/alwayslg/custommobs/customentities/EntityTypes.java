...
import static me.alwayslg.custommobs.customentities.CustomEntityZombie.getPrivateField;

public enum EntityTypes {
    //NAME("Entity name", Entity ID, yourcustomclass.class);
    CUSTOM_ZOMBIE("Zombie", 54, CustomEntityZombie.class), //You can add as many as you want.
    CUSTOM_WITHER("Wither", 64, CustomEntityWither.class);
